	...
	public static void main(String[] args) {
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				img2.setIcon(icon);
				count++;
				countLabel.setText("붕어빵" + count + "개");
				int price = PRICE * count;
				priceResult.setText(price + "원");
			}
		});
		
		JButton b2 = new JButton("계란빵");
		...
		b2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				img2.setIcon(icon);
				count2++;
				countLabel.setText("계란빵" + count2 + "개");
				int price = PRICE2 * count2;
				priceResult.setText(price + "원");
			}
		});
		
		JButton b3 = new JButton("호빵");
		...
		b3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				img2.setIcon(icon);
				count3++;
				countLabel.setText("호빵" + count3 + "개");
				int price = PRICE3 * count3;
				priceResult.setText(price + "원");
			}
		});
